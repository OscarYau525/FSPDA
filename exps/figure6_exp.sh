...
python run.py \
    ...
    --beta 1 --gamma 1 --eta 5e-9 --edge_fraction 0 --one_edge True \
    ...
    --mpirun_path /home/ubuntu/opt/openmpi/bin/mpirun --manual_seed 1 --train_fast False
...
python run.py \
    ...
    --on_cuda True --use_ipc False --comm_device cuda \
    --lr 1e-1 --lr_schedule_scheme cosine --cosine_warmup_epoch 5 \
    --beta 1 --gamma 1 --eta 1e-9 --edge_fraction 0 --one_edge True \
    --weight_decay 1e-4 --eval_consensus_only False \
...
python run.py \
    ...
    --beta 1 --gamma 1 --eta 5e-10 --edge_fraction 0 --one_edge True \
    --weight_decay 1e-4 --eval_consensus_only False \
